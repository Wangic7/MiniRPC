...
static ::_pb::Metadata file_level_metadata_proto_2frpc_5fheader_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_proto_2frpc_5fheader_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_proto_2frpc_5fheader_2eproto = nullptr;

const uint32_t TableStruct_proto_2frpc_5fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_proto_2frpc_5fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\026proto/rpc_header.proto\022\007minirpc\"I\n\tRpc"
  "Header\022\024\n\014service_name\030\001 \001(\t\022\023\n\013method_n"
  "ame\030\002 \001(\t\022\021\n\targs_size\030\003 \001(\rb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_proto_2frpc_5fheader_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto_2frpc_5fheader_2eproto = {
    false, false, 116, descriptor_table_protodef_proto_2frpc_5fheader_2eproto,
    "proto/rpc_header.proto",
    &descriptor_table_proto_2frpc_5fheader_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_proto_2frpc_5fheader_2eproto::offsets,
    file_level_metadata_proto_2frpc_5fheader_2eproto, file_level_enum_descriptors_proto_2frpc_5fheader_2eproto,
    file_level_service_descriptors_proto_2frpc_5fheader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2frpc_5fheader_2eproto_getter() {
  return &descriptor_table_proto_2frpc_5fheader_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2frpc_5fheader_2eproto(&descriptor_table_proto_2frpc_5fheader_2eproto);
namespace minirpc {
...
::PROTOBUF_NAMESPACE_ID::Metadata RpcHeader::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2frpc_5fheader_2eproto_getter, &descriptor_table_proto_2frpc_5fheader_2eproto_once,
      file_level_metadata_proto_2frpc_5fheader_2eproto[0]);
}
