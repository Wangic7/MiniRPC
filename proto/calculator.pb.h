...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2fcalculator_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2fcalculator_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_proto_2fcalculator_2eproto
...
struct TableStruct_proto_2fcalculator_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fcalculator_2eproto;
namespace minirpc {
class AddRequest;
...
class AddRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:minirpc.AddRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:minirpc.AddRequest)
 private:
  class _Internal;
...
class AddResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:minirpc.AddResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:minirpc.AddResponse)
 private:
  class _Internal;
...
inline int32_t AddRequest::a() const {
  // @@protoc_insertion_point(field_get:minirpc.AddRequest.a)
  return _internal_a();
}
...
inline void AddRequest::set_a(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:minirpc.AddRequest.a)
}
...
inline int32_t AddRequest::b() const {
  // @@protoc_insertion_point(field_get:minirpc.AddRequest.b)
  return _internal_b();
}
...
inline void AddRequest::set_b(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:minirpc.AddRequest.b)
}
...
inline int32_t AddResponse::result() const {
  // @@protoc_insertion_point(field_get:minirpc.AddResponse.result)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2fcalculator_2eproto
